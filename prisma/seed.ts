  ...
  const products = [
    {
      ...
      description_th:
        "กาแฟพิเศษจากดอยช้าง คั่วสดใหม่ หอมกลิ่นช็อกโกแลตและถั่ว บรรจุ 250 กรัม",
      description_en:
        "Specialty coffee from Doi Chang, freshly roasted with chocolate and nutty notes. 250g pack.",
      price: 450,
      stock: 120,
      image:
    ...
    },
    {
      ...
      description_th:
        "จอ 15.6 นิ้ว RAM 16GB SSD 512GB เหมาะสำหรับงานกราฟิกและโปรแกรมมิ่ง",
      description_en:
        "15.6-inch display, 16GB RAM, 512GB SSD. Ideal for graphic design and programming.",
      price: 32900,
      stock: 45,
      image:
    ...
    },
    {
      ...
      description_th:
        "น้ำหนักเบา พื้นรองเท้านุ่ม กันลื่น สวมใส่สบายตลอดวัน ขนาด 39-44",
      description_en:
        "Lightweight with soft cushioned sole, non-slip, all-day comfort. Sizes 39-44.",
      price: 1890,
      stock: 200,
      image:
    ...
    },
    {
      ...
      description_th:
        "เรื่องราวลึกลับที่ซ่อนปมซับซ้อน จบแบบหักมุม ฉบับพิมพ์ครั้งที่ 3 ปกอ่อน",
      description_en:
        "A complex mystery with unexpected twists. 3rd printing, paperback edition.",
      price: 290,
      stock: 85,
      image:
    ...
    },
    {
      ...
      description_th:
        "วัสดุทนน้ำ ดีไซน์เรียบง่าย ขนาดเส้นผ่านศูนย์กลาง 15 ซม. พร้อมถาดรองน้ำ",
      description_en:
        "Water-resistant ceramic, minimalist design, 15cm diameter with drainage tray.",
      price: 350,
      stock: 150,
      image:
    ...
    },
    {
      ...
      description_th:
        "เคลือบกันน้ำลึก 50 เมตร เครื่องควอตซ์ญี่ปุ่น สายหนังแท้ปรับขนาดได้",
      description_en:
        "50-meter water resistance, Japanese quartz movement, adjustable genuine leather strap.",
      price: 4500,
      stock: 60,
      image:
    ...
    },
    {
      ...
      description_th:
        "แบตเตอรี่ใช้งาน 30 ชม. รองรับ Bluetooth 5.3 เสียงเบสแน่น พับเก็บได้",
      description_en:
        "30-hour battery life, Bluetooth 5.3, deep bass, foldable design for portability.",
      price: 2890,
      stock: 95,
      image:
    ...
    },
    {
      ...
      description_th:
        "ซิปกันน้ำ ช่องเก็บของ 5 ช่อง สายปรับความยาวได้ สไตล์สตรีท",
      description_en:
        "Waterproof zippers, 5 storage compartments, adjustable strap, urban street style.",
      price: 790,
      stock: 110,
      image:
    ...
    },
    {
      ...
      description_th:
        "กรอบไทเทเนียม น้ำหนักเบา ป้องกันรังสี UV400 ครอบคลุม 100%",
      description_en:
        "Lightweight titanium frame, 100% UV400 protection, polarized lenses for glare reduction.",
      price: 1250,
      stock: 75,
      image:
    ...
    },
    {
      ...
      description_th:
        "เซนเซอร์ APS-C 24MP วิดีโอ 4K 60fps น้ำหนักเบาพกพาง่าย พร้อมเลนส์คิต",
      description_en:
        "24MP APS-C sensor, 4K 60fps video recording, lightweight body with kit lens included.",
      price: 28500,
      stock: 30,
      image:
